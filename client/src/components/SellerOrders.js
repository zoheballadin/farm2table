          ...
          <table class="table-fixed mr-auto ml-auto mt-12 w-[100vw]" >
            <thead className='table-header-group'>
              <tr>
                ...
                {/* <th>Responses</th> */}
                <th class="px-5 py-3 border-b-2 border-gray-200 bg-purple-800 text-left text-s font-semibold text-white uppercase tracking-wider">Buyer</th>
               ...
               item.product && <tr key={index + 1} className='table-row'>
                  ...
                  <td  class="px-5 py-5 border-b border-gray-200 bg-white table-cell">
                    <button
                       ...
                       onClick={() => navigate(`/seller/order/${item._id}`)}
                    >
                      View
                    </button>
